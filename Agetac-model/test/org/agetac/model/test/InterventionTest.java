...
public class InterventionTest {
	...
	public void jsonTransformNoException() throws Exception {
		...
		vehicules.add(new Vehicule("v1", new Position(12.155466,42.5555), CategorieVehicule.FPT, "Janzé", Vehicule.EtatVehicule.ALERTE, g, "4242"));
		vehicules.add(new Vehicule("v2", new Position(12.155466,42.5556), CategorieVehicule.FPT, "Janzé", Vehicule.EtatVehicule.ALERTE, g, "1664"));
